...
namespace imbSCI.DataComplex
{
     ...
     *  using imbSCI.Core.attributes;
        ...
        /// </summary>
        [imb(imbAttributeName.reporting_categoryOrder, "Group 1,Group 2")] // this sets order of groups in the report, groups not specified will be after specified ones
        [imb(imbAttributeName.basicColor, "#999999")] // this will set default backgroun color
        public class DataEntryTest
        {
            ...
            [imb(imbAttributeName.basicColor, "#0066FF")] // you can use string hex (RGB or ARGB)
